...
apps/
  ...
  client/        React SPA
  docs/          The user guide, as a VitePress site (docs-site.md)
packages/
...
docs/
  ...
  development/   Contributor notes — running a local CalDAV server
```

**User documentation is not in `docs/`.** It moved to `apps/docs/guide` on
2026-08-17, where VitePress builds it into a site
([docs-site](./docs-site.md)); `docs/` is now entirely for people changing
Fold. *(added 2026-08-17.)*
...
**The backlog is [GitHub Issues](https://github.com/JackCuthbert/fold/issues),
not a file.** A `backlog.md` spec existed until 2026-08-17; by then it was a
pointer to Issues plus three entries for features shipped in August 2026,
and everything it recorded had been written into the spec it pointed at.
*(added 2026-08-17.)*
...
| [quick-add](./quick-add.md) | Creating a todo from one line of text: the grammar, the launcher modal |
...
| [agentic-todo-management](./agentic-todo-management.md) | Managing todos through the curl-based agent skill |
...
| [docs-site](./docs-site.md) | The user guide site: VitePress, assets, why it is not deployed |
