...
The API is also the supported boundary for the published Fold CLI
...
| `serverUrl` outside `CALDAV_ALLOWED_HOSTS` | 403 `server_not_allowed` | login screen points at the operator — see [security](./security.md) |
