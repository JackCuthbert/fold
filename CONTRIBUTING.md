...
alternatives and measurements belong in the PR description — that is where
...
**One commit per feature or fix.** Iteration — review rounds, follow-up
fixes, "actually move it there" — gets amended or squashed into the change
it belongs to rather than stacked as separate commits.
...
the reasoning, including what was rejected. **If a change alters
